-- ============================================
-- Rivek Men's Salon - Database Setup Script
-- ============================================
-- Run this SQL in your hPanel phpMyAdmin
-- or import it via MySQL command line
-- ============================================

-- Create database (skip if already created via hPanel)
-- CREATE DATABASE IF NOT EXISTS `janisahil-salon` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE `janisahil-salon`;

-- Tokens table - stores all customer queue entries
